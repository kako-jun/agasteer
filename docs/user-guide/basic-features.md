...
SimplestNote.mdでは、ノート自体は編集せず、ノート名の変更のみ可能です。
...
ヘッダーの「SimplestNote.md」をクリックすると、ホーム画面に戻ります。

### パンくずリスト

現在の場所を表示するパンくずリストが表示されます。

例：`SimplestNote.md > ノート1 > サブノート1 > リーフ1`
...
SimplestNote.mdはURLルーティングに対応しています。
