...
> SimplestNote.mdの高度な機能を説明します。

---

## 📱 2ペイン表示

SimplestNote.mdは横長画面で左右2ペイン表示に自動切替されます。
...
SimplestNote.md専用のVimコマンドを用意しています。
...
```markdown
[SimplestNote.md > ノート1 > リーフ1](https://simplest-note-md.llll-ll.com/note/abc123/leaf/def456)
```
...
SimplestNote.mdはPWA（Progressive Web App）として動作します。
